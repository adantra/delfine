...
\section{Método dos Elementos Finitos de Galerkin para a Eq. de Pressão} \label{sc:fem}
...
\section{Método dos Elementos Finitos Mistos para a Eq. de Pressão} \label{sc:mfem}
\section{Estabilização do \ac{MEF} via \ac{SUPG} para a Eq. de Saturação} \label{sc:supg}
