...
% Adicionar figura baseada na figura do chines para a porosidade (ou copiar e citar figura da tese do demetrio).
...
\end{equation}
% [3] Cite models for relative permeability (Chen,Aziz as general, Brooks-Corey as specific)
