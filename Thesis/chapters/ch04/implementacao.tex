...
def Galerkin(self, delfineVar, parameter):
    ...
    L = v*f*dx - g*v*ds
\end{pythoncode}
\caption{Comparação entre a notação matemática e a codificação em \emph{Python} da montagem do operador elíptico via \ac{MEF} de Galerkin usando o \emph{FEniCS/DOLFIN}.}
\label{lst:arqpymfem}
\end{listing}
