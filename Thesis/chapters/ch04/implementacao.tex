...
Uma vez obtido finalizada a etapa de processamento, é necessário analisar os resultados obtidos. Em termos de implementação computacional, esta é a fase mais simples, como pode ser visto na Fig. \ref{fig:posprocessadorflux}.
